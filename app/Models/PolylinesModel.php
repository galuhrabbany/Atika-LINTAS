...
class PolylinesModel extends Model
{
    ...
    public function geojson_polylines()
    {
        ...
        '))->leftJoin('users', 'polylines.user_id', '=', 'users.id')->get();
    ...
    {
        $polylines = $this->select(DB::raw('polylines.id, st_asgeojson(polylines.geom) as geom, polylines.name, polylines.description,
        st_length(geom, true) as length_m, st_length(geom, true)/1000 as length_km, polylines.image,
